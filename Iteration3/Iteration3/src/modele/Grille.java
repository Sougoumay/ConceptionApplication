...
public class Grille extends Plateau {
    ...
    {
        return  aligner(jeton) == true;
    }

    public boolean aligner(String jeton) {
        ...
        for (int ligne = 0; ligne < taille; ligne++) {
            ...
            if (chercherAlignement(0, ligne, 1, 0,jeton)) {
                return true;
            }
        }
        ...
        for (int col = 0; col < taille; col++) {
            ...
            if (chercherAlignement(col, 0, 0, 1,jeton)) {
                return true;
            }
        }
        ...
        for (int col = 0; col < taille; col++) {
            // Première diagonale ( \ )
            if (chercherAlignement(col, 0, 1, 1,jeton)) {
                return true;
            }
            // Deuxième diagonale ( / )
            if (chercherAlignement(col, 0, -1, 1,jeton)) {
        ...
        for (int ligne = 0; ligne < taille; ligne++) {
            // Première diagonale ( / )
            if (chercherAlignement(0, ligne, 1, 1,jeton)) {
                return true;
            }
            // Deuxième diagonale ( \ )
            if (chercherAlignement(taille - 1, ligne, -1, 1,jeton)) {
                return true;
            }
        }
        // On n'a rien trouvé
    ...
    public boolean chercherAlignement(int colonne, int ligne, int modifColonne, int modifLigne, String jeton) {
